...
def single_bandit_plots(count, data, mean, var, svar):
	description = {'iteration':count, 'value':data, 'estimated mean':mean, 'estimated sample variance':var, 'estimated population variance':svar }
	...
	ax2.set_xlabel('')
	ax2.set_ylabel('')
	ax2.set_title('Estimated Mean (log x scale)')
